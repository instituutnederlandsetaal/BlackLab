...
public class ProxyBackend implements Backend {
    ...
    public Response corpusInfo(ApiVersion apiVersion, RequestCorpusInfo req) {
        Map<WebserviceParameter, String> params = Map.of(
                ...
                WebserviceParameter.OPERATION, WebserviceOperation.CORPUS_INFO.toString(),
                WebserviceParameter.LIST_VALUES_FOR_ANNOTATIONS, StringUtils.join(req.listValuesFor(), ","),
                WebserviceParameter.LIMIT_VALUES, Long.toString(req.limitValues())
        );
    ...
    public Response termFreq(ApiVersion apiVersion, String corpusName, MultivaluedMap<String, String> parameters, String method) {
        return SimpleResponse.success(Requests.request(this.client, ParamsUtil.get(parameters, corpusName,
