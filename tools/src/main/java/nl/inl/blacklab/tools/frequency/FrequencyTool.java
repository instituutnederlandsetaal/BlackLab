...
public class FrequencyTool {
    public static void main(final String[] args) throws ErrorOpeningIndex, IOException {
    ...
    private static void makeFrequencyLists(final BlackLabIndex index, final Config cfg) throws IOException {
