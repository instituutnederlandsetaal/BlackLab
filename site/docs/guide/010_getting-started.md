...
BlackLab Frontend is our corpus search application. It is easy to install; see its ([GitHub page](https://github.com/instituutnederlandsetaal/blacklab-frontend/)) for instructions.
