...
- The Dutch Language Institute ([INT](https://www.ivdnt.org/)) is leading BlackLab development and uses it for their corpora, such as its Corpus of Contemporary Dutch (3+ billion tokens [public version](https://chn.ivdnt.org/), 4.5+ billion internal), the historical [Letters as Loot](https://brievenalsbuit.ivdnt.org/) and [Corpus Gysseling](https://corpusgysseling.ivdnt.org/) and various [other corpora](https://ivdnt.org/corpora-lexica/).
...
- [CRIME](https://forensic.corpora.li/corpus-frontend/forensic_test/search/) (The Corpus of Recorded Investigative, Media, and Evidence-based Proceedings), Coats, Steven and Dana Roemling
- [CoANZSE Audio](https://coanzse.org/landing/index.html) (The Corpus of Australian and New Zealand Spoken English)
- [CO.RA.PAN](https://corapan.hispanistica.com/) Radio Corpus (Corpus Radiofónico Panhispánico), Marburg University
- [COCO@NWU](https://coco.nwu.ac.za/) (Corpus Cooperative), North-West University, South-Africa
- [VIVA Korpusportaal](http://korpus.viva-afrikaans.org/whitelab-oop/search/simple), Virtuele Instituut Vir Afrikaans (South Africa)
...
- [EarlyPrint](https://earlyprint.org/), corpus of the early English print record from 1473 to the early 1700s, Northwestern University and Washington University in St. Louis.
...
- [Alpheios Latin lemmatized texts](https://blacklab.alpheios.net/latin-texts/search)
...
- [Lexion AI](https://www.lexion.ai/) used BlackLab in their contract management system before being acquired by DocuSign. Lexion had an interestingly different use case from INT, with high query volume on many smaller indexes. We are grateful for their valuable contributions to the project.
