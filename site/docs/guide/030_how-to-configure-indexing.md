...
`process` can be used to perform simple string processing on (standoff) (sub)annotations, metadata values, and linkValues (explained [here](#linking-to-external-document-metadata)).
