...
If [user authentication and private user corpora](/server/user-corpora) are enabled, these can be used to manage the user's own corpora: creating/deleting, adding data and sharing.
...
* [Delete a documents](delete-document.md) : `DELETE /blacklab-server/<corpus-name>/docs/PID`<br>Delete this document.
