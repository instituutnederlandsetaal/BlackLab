...
This is in the
[instituutnederlandsetaal/blacklab-frontend](https://github.com/instituutnederlandsetaal/blacklab-frontend) repo.
Again, move to the
[releases](https://github.com/instituutnederlandsetaal/blacklab-frontend/releases)
page and there you find release 2.1.0.
You see a file
[corpus-frontend-2.1.0.war](https://github.com/instituutnederlandsetaal/blacklab-frontend/releases/download/v2.1.0/corpus-frontend-2.1.0.war)
there, download it and place it in the `installation` directory.
...
[GitHub repo](https://github.com/instituutnederlandsetaal/blacklab-frontend/)
