...
const _sfc_setup$18 = _sfc_main$17.setup;
...
const _sfc_setup$17 = _sfc_main$16.setup;
...
const _sfc_setup$16 = _sfc_main$15.setup;
...
const _sfc_setup$15 = _sfc_main$14.setup;
...
const _sfc_setup$14 = _sfc_main$13.setup;
...
const _sfc_setup$13 = _sfc_main$12.setup;
...
const _sfc_setup$12 = _sfc_main$11.setup;
...
const _sfc_setup$11 = _sfc_main$10.setup;
...
const _sfc_main$$ = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<p${ssrRenderAttrs(mergeProps({ class: "VPLastUpdated" }, _attrs))} data-v-e98dd255>${ssrInterpolate(((_a = unref(theme2).lastUpdated) == null ? void 0 : _a.text) || unref(theme2).lastUpdatedText || "Last updated")}:
    <time${ssrRenderAttr("datetime", isoDatetime.value)} data-v-e98dd255>${ssrInterpolate(datetime.value)}</time></p>`);
    };
  }
});
const _sfc_setup$10 = _sfc_main$$.setup;
...
const _sfc_setup$$ = _sfc_main$_.setup;
...
const _sfc_setup$_ = _sfc_main$Z.setup;
...
const _sfc_setup$Z = _sfc_main$Y.setup;
...
const _sfc_setup$Y = _sfc_main$X.setup;
...
const _sfc_setup$X = _sfc_main$W.setup;
...
const _sfc_setup$W = _sfc_main$V.setup;
...
const _sfc_setup$V = _sfc_main$U.setup;
...
const _sfc_setup$U = _sfc_main$T.setup;
...
const _sfc_setup$T = _sfc_main$S.setup;
...
const _sfc_setup$S = _sfc_main$R.setup;
...
const _sfc_setup$R = _sfc_main$Q.setup;
...
const _sfc_setup$Q = _sfc_main$P.setup;
...
const _sfc_setup$P = _sfc_main$O.setup;
...
const _sfc_setup$O = _sfc_main$N.setup;
...
const _sfc_setup$N = _sfc_main$M.setup;
...
const _sfc_setup$M = _sfc_main$L.setup;
...
const _sfc_setup$L = _sfc_main$K.setup;
...
const _sfc_setup$K = _sfc_main$J.setup;
...
const _sfc_setup$J = _sfc_main$I.setup;
...
const _sfc_setup$I = _sfc_main$H.setup;
...
const _sfc_setup$H = _sfc_main$G.setup;
...
const _sfc_setup$A = _sfc_main$z.setup;
_sfc_main$z.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(theme2).nav) {
        _push(`<nav${ssrRenderAttrs(mergeProps({
          ...
          class: "VPNavBarMenu"
        }, _attrs))} data-v-dc692963><span id="main-nav-aria-label" class="visually-hidden" data-v-dc692963>
      Main Navigation
    </span> <!--[-->`);
...
const _sfc_main$v = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.DX1Er_hQ.js"));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(hasSidebar)) {
        _push(`<aside${ssrRenderAttrs(mergeProps({
          ...
          ref_key: "navEl",
          ref: navEl
        }, _attrs))} data-v-319d5ca6><div class="curtain" data-v-319d5ca6></div> <nav class="nav" id="VPSidebarNav" aria-labelledby="sidebar-aria-label" tabindex="-1" data-v-319d5ca6><span class="visually-hidden" id="sidebar-aria-label" data-v-319d5ca6>
        Sidebar Navigation
      </span> `);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(frontmatter).layout !== false) {
        _push(`<div class="${ssrRenderClass([unref(frontmatter).pageClass, "Layout"])}" data-v-5d98c3a5>`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/vitepress-plugin-tabs/src/client/PluginTabs.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/vitepress-plugin-tabs/src/client/PluginTabsTab.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const PluginTabsTab = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-530e8f06"]]);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/theme/Redirect.vue");
...
function extractTextFromVNodes(vnodes) {
  ...
  if ("type" in vnodes) return extractTextFromVNodes(vnodes.children);
  return "";
}
function parseLines(text, tabWidth, highlightedLines) {
  const tabAsSpaces = " ".repeat(tabWidth);
  const lines = text.trim().split("\n").map((line) => line.match(LINE_REGEX)).filter((match) => !!match).map((match, lineNumber) => {
    var _a;
    const indentation = match[1].replace(/\t/g, tabAsSpaces).length;
    const name = match[2];
    const comment = ((_a = match[3]) == null ? void 0 : _a.trim()) || "";
    return {
      name,
      indentation,
      comment,
...
function parseHighlightedLineNumbers(hl) {
  return (hl == null ? void 0 : hl.split(",").map((h2) => h2.trim()).filter((h2) => h2.match(/^\d+(-\d+)?$/)).map((h2) => {
    const [start, end] = h2.split("-").map(Number);
    return [start - 1, end && end > start ? end - 1 : start - 1];
  })) ?? [];
}
function renderConnectorAndName(line) {
...
const FileTree$1 = defineComponent({
  name: "FileTree",
  props: {
  ...
  render() {
    ...
    const textContent = extractTextFromVNodes(((_b = (_a = this.$slots).default) == null ? void 0 : _b.call(_a)) || []);
...
const _sfc_setup = FileTree$1.setup;
FileTree$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/theme/FileTree.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const FileTree = /* @__PURE__ */ _export_sfc(FileTree$1, [["__scopeId", "data-v-eac3b36f"]]);
const linkTitles = {
    ...
    if (inBrowser) {
      setTimeout(() => {
        ...
        navLinks.forEach((link2) => {
          const url = link2.href.trim().replace(/https?:\/\/([^\/].*[^\/])\/?/, "$1");
          if (!link2.title && url in linkTitles) {
            link2.title = linkTitles[url];
          }
        });
      }, 100);
    }
