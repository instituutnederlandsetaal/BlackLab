...
import "markdown-it";
const localSearchIndex = { "root": () => import("./@localSearchIndexroot.DcwaHmDJ.js") };
class LRUCache {
  constructor(max = 10) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(filterText) && !results.value.length && enableNoResults.value) {
          _push2(`<li class="no-results" data-v-ce626c7c>${ssrInterpolate(unref(translate)("modal.noResultsText"))} &quot;<strong data-v-ce626c7c>${ssrInterpolate(unref(filterText))}</strong>&quot;
          </li>`);
        } else {
          _push2(`<!---->`);
        }
