...
We do generally assume that most users are using the REST API, not the Java code, so we are less worried about making Java changes than changing the API.
