 ...
 */
public class TestProcessingStepsType {
    ...
    public void testMap() {
        ...
        ProcessingStep step = new ProcessingInstructionMapValues.ProcessingStepMapValues(mapping);
    ...
    public void testUnique() {
        ProcessingStep step = new ProcessingInstructionUnique().get();
    ...
    public void testMultiple() {
        ProcessingStep step = new ProcessingInstructionMultiple.ProcessingStepMultiple(List.of(
                new ProcessingInstructionStrip.ProcessingStepStrip(" "),
                new ProcessingInstructionReplace.ProcessingStepReplace("c", "x", "i", "replaced"),
                new ProcessingInstructionAppend.ProcessingStepAppend("_", "|", "test", null)
        ));
        test("  NOU-C  ", step, "NOU-x|testValue");
        test("NOU-P", step, "NOU-P|testValue");
        test("  ", step, "testValue");
        test("bla", new ProcessingInstructionMultiple.ProcessingStepMultiple(Collections.emptyList()), "bla");
    }
    ...
    private void testStrip(String input, String chars, String expected) {
        test(input, new ProcessingInstructionStrip.ProcessingStepStrip(chars), expected);
    }
    ...
    private void testSplit(String input, String separator, String keep, List<String> expected) {
        test(input, new ProcessingInstructionSplit.ProcessingStepSplit(separator, "", keep), expected);
    }
    ...
    private void testAppend(String input, String separator, String prefix, String field, String fixedValue, String expected) {
        test(input, new ProcessingInstructionAppend.ProcessingStepAppend(separator, prefix, field, fixedValue), expected);
    }
    ...
    private void testConcatDate(String input, String autofill, String expected) {
        test(input, new ProcessingInstructionConcatDate.ProcessingStepConcatDate("year", "month", "day", autofill), expected);
    }
    ...
    private void testReplace(String input, String regex, String replacement, String flags, String expected) {
        test(input, new ProcessingInstructionReplace.ProcessingStepReplace(regex, replacement, flags, "replaced"), expected);
    }
    ...
    public void testParsePos(String input, String feature, String expected) {
        test(input, ProcessingInstructionParsePos.ProcessingStepParsePos.feature(feature), expected);
    }
