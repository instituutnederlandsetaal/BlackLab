...
/**
 * An educational input format class to learn how to implement your own.
 *
 ...
 * input format class. This shows how to do that.
 *
 ...
 *
 * The input files that this class can process are a sort of "assembly
...
public class InputFormatTypeExample extends InputFormatTypeBase {
    ...
    public static class InputFormatExample extends InputFormatBase {
        ...
        protected Doc createDoc(DocWriter docWriter, FileReference file) {
            return new DocExample(docWriter, file);
        }

        class DocExample extends DocBase {
            ...
            public DocExample(DocWriter docWriter, FileReference file) {
            ...
            private void executeValueCommand(String command, String[] parameters) {
                ...
                case "SPAN":
                    ...
                    //   tags inline. See InputFormatTypeBase.DocBase.inlineTag().
                ...
                default:
                    throw new InvalidInputFormatConfig(
                            "Command " + command + " cannot appear inside annotated field block");
                }
            }
            ...
            public IndexerStats indexSpecificDocument(String documentExpr, Doc linkingDoc, String storeWithName) {
                ...
                throw new UnsupportedOperationException(
                        "indexSpecificDocument() not implemented in this example indexer");
            }
