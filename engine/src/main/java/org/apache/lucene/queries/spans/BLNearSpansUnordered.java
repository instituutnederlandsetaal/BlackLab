...
/**
 * Similar to {@link BLNearSpansOrdered}, but for the unordered case.
 *
 * <p>Expert: Only public for subclassing. Most implementations should not need this class
 */
public class BLNearSpansUnordered extends BLConjunctionSpans {

  private final int allowedSlop;
  private SpanTotalLengthEndPositionWindow spanWindow;

  public BLNearSpansUnordered(int allowedSlop, List<BLSpans> subSpans) throws IOException {
