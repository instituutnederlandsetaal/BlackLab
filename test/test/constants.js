...
const INDEX_TYPE = process.env.INDEX_TYPE || "default"; // what index type are we testing? (separate responses)
const OPT_INDEX_TYPE_PATH = INDEX_TYPE === "default" ? "" : `-${INDEX_TYPE}`;
